class life_wanted_menuCiv {
	idd = 2400;
	name= "life_wanted_menuCiv";
	movingEnable = false;
	...
	class WantedAddL2: Life_RscCombo{
			idc = 2407;
			x = 0.542;
			y = 0.28;
			w = (8 / 52);
	...
	class wantedText2: Life_RscText {
			idc = 1000;
	...
	class citizensText2: Life_RscText {
			idc = 1001;
	...
	class crimesText2: Life_RscText {
			idc = 1002;
