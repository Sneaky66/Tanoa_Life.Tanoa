...
/* System Settings */
    ...
    revive_fee = 5500; //Revive fee that players have to pay and medics only EMS(independent) are rewarded with this amount.
    ...
    crimes[] = {
        ...
        {"STR_Crime_28","20000","28"},
        {"STR_Crime_919","60000","919"}
    };
};
