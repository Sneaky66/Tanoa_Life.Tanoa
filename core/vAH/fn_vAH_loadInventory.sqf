...
while {true} do
{
	...
	if (isNull (findDisplay 15600)) exitWith {};
	sleep 1;
	((findDisplay 15600) displayCtrl 15660) ctrlSetText "images\vAH\fattony01.jpg";
	if (isNull (findDisplay 15600)) exitWith {};
	sleep 0.1;
	((findDisplay 15600) displayCtrl 15660) ctrlSetText "images\vAH\fattony02.jpg";
	if (isNull (findDisplay 15600)) exitWith {};
	sleep 0.1;
	((findDisplay 15600) displayCtrl 15660) ctrlSetText "images\vAH\fattony03.jpg";
	if (isNull (findDisplay 15600)) exitWith {};
	sleep 0.1;
	((findDisplay 15600) displayCtrl 15660) ctrlSetText "images\vAH\fattony04.jpg";
	if (isNull (findDisplay 15600)) exitWith {};
	sleep 0.1;
	((findDisplay 15600) displayCtrl 15660) ctrlSetText "images\vAH\fattony.jpg";
	if (isNull (findDisplay 15600)) exitWith {};
};
