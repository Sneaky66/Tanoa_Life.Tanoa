...
if(_speed > 85) then {_info = format ["<t color='#5A80EB'><t size='1.5'><t align='center'>Speed Radar<br/><t color='#FF0000'><t align='center'><t size='1'>Speed %1 MPH", _speed];
}else{
_info = format ["<t color='#5A80EB'><t size='1.5'><t align='center'>Radar<br/><t color='#33CC33'><t align='center'><t size='1'>Speed %1 MPH", _speed];
};
...
_info = _info + format ["<br/><t color='#5A80EB'><t size='1.5'><t align='center'>Vehicle Owner:<br/><t color='#33CC33'><t align='center'><t size='1'> %1", _owner];
};
_info = _info + format ["<br/><t color='#5A80EB'><t size='1.5'><t align='center'>Vehicle Type:<br/><t color='#33CC33'><t align='center'><t size='1'> %1", _type];
