...
if (_curObject isKindOf "House_F" && {player distance _curObject < 12} || ((nearestObject [[7362.12,7575.83,0.00266576],"Land_Dome_Big_F"]) == _curObject || (nearestObject [[7362.12,7575.83,0.00266576],"Land_Research_house_V1_F"]) == _curObject)) exitWith {
...
if (isPlayer _curObject && _curObject isKindOf "Man") then {
    if(_curObject distance player < 5 && !dialog && playerSide == west) then {
