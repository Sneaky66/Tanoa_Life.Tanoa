...
if (_curTarget isKindOf "House_F" && playerSide isEqualTo west) exitWith {
    if ((nearestObject [[7362.12,7575.83,0.00266576],"Land_Dome_Big_F"]) == _curTarget || (nearestObject [[7362.12,7575.83,0.00266576],"Land_Research_house_V1_F"]) == _curTarget) then {
